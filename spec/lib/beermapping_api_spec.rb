...
describe "BeermappingApi" do
    ...
    describe "in case of cache miss" do
        ...
        it "When HTTP GET returns zero entries, an emprty XML is returned" do
     ...
     describe "in case of cache hit" do
        ...
        it "When many entries in cache, all of them are returned" do
